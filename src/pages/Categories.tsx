      ...
      <section className="section bg-gradient-to-br from-blue-dark to-blue-deep text-white">
        <div className="container text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto leading-relaxed">
            Découvrez les 15 catégories officielles des Hospitality Awards Guinée et 
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-blue-dark mb-6">
              Nos <span className="text-gold">15 catégories</span> officielles
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Les catégories officielles reconnues par les Hospitality Awards Guinée pour récompenser l'excellence dans le secteur
            </p>
          </div>
      ...
      <section className="section bg-blue-dark text-white">
        <div className="container text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Choisissez votre catégorie parmi nos 15 catégories officielles et soumettez votre candidature pour 
            les Hospitality Awards Guinée 2024.
          </p>
